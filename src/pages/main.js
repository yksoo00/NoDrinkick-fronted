...
const Main = () => {
  ...
  const handleMenuToggle = (gpsId) => {
    console.log("id", gpsId);
    setId(gpsId); // 고유 ID 설정
  ...
  return (
    <div>
      ...
      <LogoDrawer open={menuOpen} onClose={() => setMenuOpen(false)} gpsId={gpsId} />
